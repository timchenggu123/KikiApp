...
<div class="w-full h-5 rounded-md bg-base-600 mb-4 shadow-xl border-b-2 border-b-base-500 border-r-2 border-r-base-300 flex gap-4 px-4">
...
<div class="h-full max-h-35 w-full flex justify-center items-center">
    <p class="text-2xl">🎉OMG! I can't believe you've done it again! You are the best!🎉</p>
</div>
{/if}
